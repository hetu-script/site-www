import{r as a,o as e,c as p,a as t,b as c,w as o,F as r,d as l,e as n}from"./app.12b41512.js";import{_ as i}from"./plugin-vue_export-helper.21dcd24c.js";const u={},k=l(`<h1 id="class" tabindex="-1"><a class="header-anchor" href="#class" aria-hidden="true">#</a> Class</h1><p>Class can have static variables and methods. Which can be accessed through the class name.</p><p>Class&#39;s member functions use special keyword: <strong>construct, get, set</strong>, to define a constructor, getter, setter function.</p><p>Constructors can be with no function name and cannot return values. When calling they will always return a instance.</p><p>Getter &amp; setter functions is used like a member variable. They can be accessed without brackets.</p><div class="language-typescript ext-ts line-numbers-mode"><pre class="language-typescript"><code><span class="token comment">// class definition</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br></div></div>`,18),m=n("Refer "),b=n("Do statement"),d=n(" for another kind of code block.");function h(f,y){const s=a("RouterLink");return e(),p(r,null,[k,t("p",null,[m,c(s,{to:"/docs/en-US/syntax/control_flow/#do"},{default:o(()=>[b]),_:1}),d])],64)}var v=i(u,[["render",h]]);export{v as default};
