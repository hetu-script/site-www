...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br></div></div>`,26),m=n("Refer "),b=n("Do statement"),d=n(" for another kind of code block.");function h(g,f){const s=a("RouterLink");return e(),p(r,null,[k,t("p",null,[m,c(s,{to:"/en-US/grammar/control_flow/#do"},{default:o(()=>[b]),_:1}),d])],64)}var v=u(i,[["render",h]]);export{v as default};
