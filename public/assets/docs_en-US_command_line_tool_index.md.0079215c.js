import{_ as a,c as e,o as n,a as t}from"./app.7121ab72.js";const g='{"title":"Command line tool - Hetu Script Language","description":"","frontmatter":{"title":"Command line tool - Hetu Script Language"},"headers":[{"level":2,"title":"Installation","slug":"installation"},{"level":2,"title":"REPL","slug":"repl"},{"level":2,"title":"Format","slug":"format"},{"level":2,"title":"Analyze","slug":"analyze"},{"level":2,"title":"Run","slug":"run"}],"relativePath":"docs/en-US/command_line_tool/index.md","lastUpdated":1638780789673}',o={},s=t(`<h1 id="hetu-script-command-line-tool" tabindex="-1">Hetu Script command line tool <a class="header-anchor" href="#hetu-script-command-line-tool" aria-hidden="true">#</a></h1><p>A command line REPL tool for testing.</p><h2 id="installation" tabindex="-1">Installation <a class="header-anchor" href="#installation" aria-hidden="true">#</a></h2><p>You can activate this tool globally, by the following command:</p><div class="language-"><pre><code>dart pub global activate hetu_script_dev_tools
...
<span class="token operator">&gt;&gt;&gt;</span>
  ...
  --script(-s)
</code></pre></div>`,21),l=[s];function r(p,i,c,d,u,h){return n(),e("div",null,l)}var f=a(o,[["render",r]]);export{g as __pageData,f as default};
